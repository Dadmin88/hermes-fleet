...
| 6 | NEXT | Persistent Agent Instances. Existing Phase 6 code/docs remain evidence candidates only until the phase is re-audited from the master plan under the canonical PR + green-CI closure rule. |
