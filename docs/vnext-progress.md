...
| 5 | NEXT | Host-action broker. Existing Phase 5 code/docs remain evidence candidates only until the phase is re-audited from the master plan under the canonical PR + green-CI closure rule. |
